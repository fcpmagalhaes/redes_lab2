...
def chat_client():
    if(len(sys.argv) != 3) :
        print 'Utilize : python client.py localhost numero_da_porta'
        sys.exit()
    ...
    nome =raw_input("\nOla, seja bem vindo! Digite seu nome: ") 
    print 'Conectado a um servidor remoto. Voce pode comecar a enviar mensagens'
    print
